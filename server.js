...
const URL= process.env.MONGODB_URI`mongodb://${username}:${password}@ac-mp7kghb-shard-00-00.pmojek1.mongodb.net:27017,ac-mp7kghb-shard-00-01.pmojek1.mongodb.net:27017,ac-mp7kghb-shard-00-02.pmojek1.mongodb.net:27017/?ssl=true&replicaSet=atlas-80nmc0-shard-0&authSource=admin&retryWrites=true&w=majority`;
